...
const rows = [
  {
    id: "userLeavesCategories.leaveCategoryId",
    align: "left",
  ...
  {
    id: "userLeavesCategories.numberOfDaysAllowed",
    align: "left",
    disablePadding: false,
...
function NumberOfLeavesTableHead(props) {
...
export default NumberOfLeavesTableHead;
